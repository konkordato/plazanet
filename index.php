...
<head>
    ...
    <!-- CSS Dosyaları - URL() FONKSİYONU İLE DÜZELTİLDİ -->
    <link rel="stylesheet" href="<?php echo url('assets/css/style.css'); ?>">
    <link rel="stylesheet" href="<?php echo url('assets/css/override.css'); ?>">
    <link rel="stylesheet" href="<?php echo url('assets/css/logo-fix.css'); ?>">
    ...
    <script src="<?php echo url('assets/js/lazy-load.js'); ?>" defer></script>
</head>
            ...
            <div class="container">
                <div class="logo-area">
                    <a href="<?php echo url('index.php'); ?>" class="logo-link">
                        <img src="<?php echo url('assets/images/plaza-logo-buyuk.png'); ?>" alt="Plaza Emlak & Yatırım" class="logo-img">
                    </a>
                    <!-- SLOGAN BÖLÜMÜ -->
                ...
                <ul class="nav-menu">
                    <li><a href="<?php echo url('index.php'); ?>" class="active">Ana Sayfa</a></li>
                    <li><a href="<?php echo url('pages/satilik.php'); ?>">Satılık</a></li>
                    <li><a href="<?php echo url('pages/kiralik.php'); ?>">Kiralık</a></li>
                    <li><a href="<?php echo url('pages/hizmetlerimiz.php'); ?>">Verdiğimiz Hizmetler</a></li>
                    <li><a href="<?php echo url('pages/hakkimizda.php'); ?>">Hakkımızda</a></li>
                    <li><a href="<?php echo url('pages/iletisim.php'); ?>">İletişim</a></li>
                    <li><a href="<?php echo url('admin/'); ?>" class="admin-btn">Yönetim</a></li>
                </ul>
    ...
    <section class="hero">
        ...
        <div class="hero-content">
            ...
            <div class="search-box">
                <form method="GET" action="<?php echo url('search.php'); ?>">
                ...
                <?php if (count($properties) > 0): ?>
                    <?php foreach ($properties as $property): ?>
                        <div class="property-card">
                            <!-- ÖNEMLİ: Link düzeltildi - url() fonksiyonu ile -->
                            <a href="<?php echo url('detail.php?id=' . $property['id']); ?>">
                                <div class="property-image">
                                    <?php if ($property['image_path']): ?>
                                        <?php 
                                        // Resim yolunu düzelt
                                        $imagePath = ltrim($property['image_path'], '/');
                                        ?>
                                        <img class="lazy"
                                            src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3E%3C/svg%3E"
                                            data-src="<?php echo url($imagePath); ?>"
                                ...
                                <div class="property-info">
                                    ...
                                    <div class="property-features">
                                        <?php if (!empty($property['oda_sayisi'])): ?>
                                            <span>🏠 <?php echo htmlspecialchars($property['oda_sayisi']); ?></span>
                                        <?php endif; ?>
                                        <?php if (!empty($property['brut_metrekare'])): ?>
                                            <span>📐 <?php echo htmlspecialchars($property['brut_metrekare']); ?>m²</span>
                                        <?php endif; ?>
                                        <?php if (!empty($property['bulundugu_kat'])): ?>
                                            <span>🏢 <?php echo htmlspecialchars($property['bulundugu_kat']); ?>. Kat</span>
                                        <?php endif; ?>
                                    </div>
