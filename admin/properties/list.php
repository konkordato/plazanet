        ...
        <nav class="sidebar">
            ...
            <ul class="sidebar-menu">
                <?php if ($_SESSION['user_role'] === 'admin'): ?>
                    ...
                    <li><a href="list.php" class="active">🏢 İlanlar</a></li>
                    <li><a href="add-step1.php">➕ İlan Ekle</a></li>
                    <li><a href="../users/list.php">👥 Kullanıcılar</a></li>
                    <li><a href="../portfolio/closing.php">💰 Portföy Kapatma</a></li>
                    <li><a href="../portfolio/closing-list.php">📋 Kapatma Listesi</a></li>
                    <li><a href="../portfolio/reports.php">📊 Satış Raporları</a></li>
                    <li><a href="../portfolio/commission-settings.php">⚙️ Prim Ayarları</a></li>
                    <li><a href="../portfolio/closed-properties.php">🔒 Kapatılan İlanlar</a></li>
                ...
                <?php else: ?>
                    ...
                    <li><a href="../my-properties.php" class="active">🏢 İlanlarım</a></li>
                    <li><a href="add-step1.php">➕ İlan Ekle</a></li>
                    <li><a href="../portfolio/closing.php">💰 Portföy Kapatma</a></li>
                    <li><a href="../portfolio/my-reports.php">📊 Satış Raporlarım</a></li>
                    <li><a href="../crm/index.php">📊 CRM Sistemi</a></li>
