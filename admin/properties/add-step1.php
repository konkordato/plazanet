...
<body>
    ...
    <div class="top-navbar">
        <div class="navbar-left">
            <h3>İlan Ekle - Kategori Seçimi</h3>
        </div>
        <div class="navbar-right">
            <span>Hoşgeldin, <?php echo htmlspecialchars($_SESSION['user_fullname'] ?? $_SESSION['username'] ?? 'Kullanıcı'); ?></span>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="buttons">
                <?php
                $geri_link = ($_SESSION['user_role'] === 'admin') ? '../dashboard.php' : '../user-dashboard.php';
                ?>
                <button type="button" class="btn btn-back" onclick="window.location.href='<?php echo $geri_link; ?>'">
                    ← Geri
                </button>
