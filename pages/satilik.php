...
<body>
        ...
        <nav class="navbar">
            <div class="container">
                ...
                <ul class="nav-menu">
                    ...
                    <li><a href="satilik.php" class="active">Satılık</a></li>
    ...
    <section class="page-header">
        <div class="container">
            ...
            <p>Tüm satılık gayrimenkul portföyümüz</p>
        </div>
    </section>
    ...
    <section class="properties">
        <div class="container">
            <div class="results-info">
                <p>Toplam <strong><?php echo count($properties); ?></strong> satılık ilan bulundu</p>
            </div>
            ...
            <div class="property-grid">
                ...
                <?php else: ?>
                    <div class="no-results">
                        <p>Henüz satılık ilan bulunmamaktadır.</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <!-- Mobil Menü JavaScript - DÜZGÜN KONUMDA -->
    <script>
